...
})({"8pEJm":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "096b593c867c46a2";
...
},{}],"ksPOP":[function(require,module,exports) {
const WIDTH = 1000;
const HEIGHT = 800;
...
function getSquare(divider, w, h) {
    const halfW = w / 2;
    const halfH = h / 2;
...
function drawPoly(ctx, opacity, points) {
...
function drawLinesToCenter(ctx) {
...
},{}]},["8pEJm","ksPOP"], "ksPOP", "parcelRequirefcd4")

//# sourceMappingURL=index.867c46a2.js.map
